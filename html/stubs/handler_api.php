...
function getMongoDBConnection($database = 'manager') {
    try {
        $mongoClient = new Client("mongodb://manager:Aman4242434@69.62.73.7:27017/manager?authSource=manager&retryWrites=true&w=majority&appName=Cluster0"); 
